<div class="MainPage">
  ...
  <div class="CowStats">
    <div><span class="CowStatIcon"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <span class="CowStatInfo">Total</span><span class="CowStatValue">10</span>
    </div>
    <div>
      ...
      <span class="CowStatIcon"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        </svg></span><span class="CowStatInfo">Healthy</span><span class="CowStatValue">10</span>
    </div>
    <div>
      ...
      <span class="CowStatValue">10</span>
    </div>
    ...
    <div>
      ...
      <span class="CowStatIcon"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        </svg></span><span class="CowStatInfo">Pregnant</span><span class="CowStatValue">10</span>
    </div>
  ...
  for ($i = 0; $i < 5; $i++) {
    ...
    ?>
    <div class="card CowCard" id="<?php echo "GR-" . $i; ?>">
      <h5 class="card-header">GR-1</h5>
